...
1	pbkdf2_sha256$12000$6mfYw8F3ageE$OgL20UMdPVk9UBcmp17fLRuNlA0gZPZZmtP4ZVlk60Q=	2014-08-27 23:19:34.578888+00	t	admin			admin@example.com	t	t	2014-08-27 19:04:02.948575+00
\.
...
1	2014-08-27 22:47:18.33059+00	1	7	1	What's up?	2	Changed pub_date.
2	2014-08-27 23:19:41.183292+00	1	7	1	What's up?	2	Changed pub_date.
\.
...
c41otjrwsopyw01t243qji2uodl1eypn	NWVlZTU3NzA1OTQ0NDYyYmNhYzdiMmVmNTdiZjQ0ZGIzZmI5MWM5ZDp7fQ==	2014-09-10 23:19:42.659877+00
\.
...
COPY polls_choice (id, poll_id, choice_text, votes) FROM stdin;
1	1	Not much	4
2	1	The sky	5
\.
...
COPY polls_poll (id, question, pub_date) FROM stdin;
1	What's up?	2014-08-27 20:10:15+00
\.
...
SELECT pg_catalog.setval('polls_poll_id_seq', 1, true);
...
--
-- Name: user_id_refs_id_c0d12874; Type: FK CONSTRAINT; Schema: public; Owner: -
--
